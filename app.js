...
const resultsTxt = document.querySelector(".resultText");

//resultsTxt.innerHTML = "testing";
   ...
   console.log(flippedCards);
    ...
    if(flippedCards.length === 2){
        if(flippedCards[0].getAttribute('name') ===flippedCards[1].getAttribute('name') ){
            ...
            if(matchcnt === 8)
            {
                resultsTxt.innerHTML = "YOU ARE WORTHY OF THE BO! WELL DONE.";
            }
        }
        else{
            flippedCards.forEach(card=>{
            ...
            if(playersLives === 0)
            {
                resultsTxt.innerHTML = "YOU DON'T KNOW BO!  GET OUUTA HERE!";
 //               setTimeout(() => (resultsTxt.innerHTML = "you suck at this"), 1000);
